...
namespace FriChat.Infrastructure.Migrations
{
    ...
    [Migration("20250708174858_ChangedUserMediaIdToNotRequiredInMessages")]
    partial class ChangedUserMediaIdToNotRequiredInMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FriChat.Infrastructure.Data.Models.Message", b =>
                {
                    ...
                    b.Property<int>("ConversationId")
                        .HasColumnType("integer")
                        .HasComment("Identifier for the conversation to which this message belongs");
                    ...
                    b.Property<int?>("UserMediaId")
                        .HasColumnType("integer")
                        .HasComment("Identifier for the UserMedia to which belongs");
            ...
            modelBuilder.Entity("FriChat.Infrastructure.Data.Models.UserMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasComment("Unique identifier for the user media");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("Id"));

                    b.Property<int>("ConversationId")
                        .HasColumnType("integer")
                        .HasComment("Identifier for the conversation associated with the media");

                    b.Property<int>("Type")
                        .HasColumnType("integer")
                        .HasComment("Type of the media file (e.g., image, video)");

                    b.Property<DateTime>("UploadedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasComment("Timestamp when the media was uploaded");

                    b.Property<string>("Url")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)")
                        .HasComment("URL of the media file uploaded by the user");

                    b.Property<int>("UserId")
                        .HasColumnType("integer")
                        .HasComment("Identifier for the user who uploaded the media");
            ...
            modelBuilder.Entity("FriChat.Infrastructure.Data.Models.Message", b =>
                {
                    ...
                    b.HasOne("FriChat.Infrastructure.Data.Models.UserMedia", "UserMedia")
                        .WithMany()
